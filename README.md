...
This repository contains the configuration for a complete, semi-autonomous AI software development team in Google Antigravity. This team consists of **12 specialized agents** and strict workflows to build high-quality software from idea to production.
